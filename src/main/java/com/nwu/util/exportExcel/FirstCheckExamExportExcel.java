...
public class FirstCheckExamExportExcel {
     ...
     */
    public FirstCheckExamExportExcel(HttpServletResponse response,
                                     String schoolName,
    ...
    private void setResponse() throws UnsupportedEncodingException {
        ...
        String name = this.schoolName + this.year + "年" + this.departmentName + "初审汇总表";
        // 这里URLEncoder.encode可以防止中文乱码 当然和easyexcel没有关系
